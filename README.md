...
This project allows controlling a Raspberry Pi running Crankshaft NG https://github.com/opencardev/crankshaft (an Android Auto headunit software) using the MMI (Multi Media Interface) controls connected to an Audi RNS-E navigation unit via the vehicle's Infotainment CAN bus (100 kbit/s).
